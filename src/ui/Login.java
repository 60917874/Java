...
public class Login extends JFrame {
    ...
    protected void imgSalir_mouseClicked() {
        if (JOptionPane.showConfirmDialog(this, "¿Desea salir?", "Salir",
    ...
    protected void txt_keyTyped(JTextField txt, KeyEvent e) {
        ...
        if (!Character.isDigit(digito) || txt.getText().length() == txt.getColumns())
            e.consume();
    }
    ...
    protected void btnIniciar_actionPerformed() {
        ...
        if (sDni.isEmpty() || sDni.length() < txtDni.getColumns() || sPasswordd.isEmpty()
